$(document).ready(function(){ 
    ...
    var orden=" DESC ";
    listado_propietarios();
    
    function listado_propietarios(){
        var campO = campo;
        var ordeN = orden;
        var llamador = "listado_propietarios";
        ...
        $.ajax({
            ...
            data: parametros,
            error : function(q) {
                mostrar_msg("Ocurrio un error al consultar el listado de Propietarios");
            },
